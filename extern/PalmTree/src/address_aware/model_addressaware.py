...
from address_aware.address_embedding import AddressAwareBERTEmbedding
...
class AddressAwareBERT(nn.Module):
    ...
    def forward(self, token_ids, segment_labels, binary_pos, function_pos, bb_pos, var_offsets=None, is_daddr=None):
        ...
        Args:
            ...
            is_daddr: [batch_size, seq_len] (optional, binary indicator for daddr tokens)
        ...
        # Get embeddings with address, var, and daddr awareness
        x = self.embedding(token_ids, segment_labels, binary_pos, function_pos, bb_pos, var_offsets, is_daddr)
...
class AddressAwareBERTForPretraining(nn.Module):
    ...
    def forward(self, token_ids, segment_labels, binary_pos, function_pos, bb_pos, var_offsets=None, is_daddr=None, corpus_type='cfg'):
        """
        ...
        """
        # Get BERT output
        sequence_output = self.bert(token_ids, segment_labels, binary_pos, function_pos, bb_pos, var_offsets, is_daddr)
    ...
    def forward_im(self, token_ids, segment_labels, binary_pos, function_pos, bb_pos, var_offsets=None, corpus_type='cfg'):
        """
