...
echo "========================================================================"
echo "Generating jTrans_instr Dataset (Instruction-Level Jump Addressing)"
echo "========================================================================"
echo ""
echo "This script will:"
echo "  1. Delete old incomplete pickle files"
echo "  2. Run IDA Pro on ALL binaries to generate complete extractions"
echo "  3. Generate function dataset with instr_addr_{i} jump tokens"
echo ""
...
echo "========================================================================"
echo ""
echo "jTrans_instr dataset files:"
echo "  - $OUTPUT_DIR/func_blocks_baseline.json"
echo "  - $OUTPUT_DIR/ground_truth_baseline.json"
echo ""
echo "Jump token format: instr_addr_{0..200}, instr_addr_exceed, unknown_instr_addr"
echo ""
echo "Next steps:"
echo "  1. Build vocabulary from generated data"
echo "  2. Run jTrans_instr pretraining"
echo "  3. Run jTrans_instr finetuning"
echo ""
