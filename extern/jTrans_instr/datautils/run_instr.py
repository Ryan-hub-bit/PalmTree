...
parser = argparse.ArgumentParser(description='Run IDA Pro batch extraction for jTrans_instr')
...
parser.add_argument('--process-script', default='./process_instr.py', help='Path to process_instr.py script')
