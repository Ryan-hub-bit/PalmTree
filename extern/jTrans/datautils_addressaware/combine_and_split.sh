...
echo ""
echo "Next steps:"
echo "1. Create vocabulary: cd ../pretrain/address_aware"
echo "2. Run: python -c 'from vocab import WordVocab; WordVocab.create_vocab(\"$TRAIN_FILE\", \"vocab.pkl\")'"
echo "3. Train: bash run_addressaware_pretrain.sh"
