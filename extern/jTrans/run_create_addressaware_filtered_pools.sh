#!/bin/bash
# Create filtered evaluation pools for AddressAware
# Guarantees:
...
python3 create_filtered_addressaware_pools.py \
    --func-blocks /data/kun/jtrans/addressaware/eval/func_blocks_addr.json \
    --ground-truth /data/kun/jtrans/addressaware/eval/ground_truth_addr.json \
    --output-dir /data/kun/jtrans/addressaware/eval/pools_filtered \
    --min-instructions 11
