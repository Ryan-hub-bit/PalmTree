...
python finetune.py \
  ...
  --model_path /home/kun/Document/AAE/output/jtrans/addressaware_baseline/checkpoint_epoch_4 \
  --output_path /home/kun/Document/AAE/output/jtrans/addressaware_finetune_baseline \
  --batch_size 16 \
  --eval_batch_size 32 \
  --lr 2e-5 \
  --epoch 15 \
