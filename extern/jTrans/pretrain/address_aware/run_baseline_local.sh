...
# LOCAL: Baseline (MLM + JTP, with binary_pos)
# Usage: ./run_baseline_local.sh [data_ratio]
# Example: ./run_baseline_local.sh 0.1
...
echo "=========================================="
echo "LOCAL: Baseline Pretraining (MLM + JTP, with binary_pos)"
...
python3 train_addressaware.py \
    ...
    --output_dir /home/kun/Document/AAE/output/jtrans/addressaware_baseline \
    --batch_size 64 \
    --learning_rate 1e-4 \
    --num_epochs 2 \
    --warmup_steps 10000 \
