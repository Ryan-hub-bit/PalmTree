...
# HPC: No JTP (MLM only, with binary_pos)
# Usage: ./run_no_jtp_hpc.sh [data_ratio]
# Example: ./run_no_jtp_hpc.sh 1.0
...
echo "=========================================="
echo "HPC: No JTP Pretraining (MLM only)"
...
python3 train_addressaware.py \
  ...
  --output_dir /work/kliu14/jtransoutput/addressaware_no_jtp \
  --batch_size 128 \
  --learning_rate 1e-4 \
  --num_epochs 20 \
  --warmup_steps 10000 \
