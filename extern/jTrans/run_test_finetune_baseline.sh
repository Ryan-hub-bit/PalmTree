#!/bin/bash
# Quick test pipeline with small data for verification
...
OUTPUT_DIR="/home/kun/Document/AAE/output/jtrans/baseline_finetune_test"
...
WEIGHT_DECAY=0.01
FREEZE_CNT=10
DATA_RATIO=0.001  # Use 0.1% of data for quick test
...
echo "Data ratio: ${DATA_RATIO} (0.1% of data)"
