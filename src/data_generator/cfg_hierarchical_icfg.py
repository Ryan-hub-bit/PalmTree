...
def process_file(fpath: str):
    ...
    for func in bv.functions:
        ...
        for block in func.basic_blocks:
            ...
            func_bbs.append((bb_start_addr, bb_end_addr))
        
        func_info.append((func.name, func_start, func_end, func_bbs))
        bb_info[func.name] = sorted(func_bbs, key=lambda x: x[0])
                ...
                for block in called_func.basic_blocks:
                    ...
                    if last_inst_addr is not None:
                        ...
                        if last_inst.lower().startswith('ret'):
                            # Add edge: return_instruction → return_address (next instruction after call)
