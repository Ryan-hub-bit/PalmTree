#!/bin/bash
#
# Generate Function Similarity JSON with CFG-style format using IDA Pro
# 
# This script processes all binaries in the funcsim dataset and generates
# JSON files with function instructions formatted like CFG output.
#
...
#       ...
#
# Usage: ./generate_funcsim_cfg_format.sh [dataset_path]
# Example: ./generate_funcsim_cfg_format.sh /data/kun/funcsim_dataset
#
...
echo "================================================"
echo "Generate Function Similarity JSON (CFG Format)"
echo "================================================"
...
" 2>/dev/null; then
        ...
        for opt in "${OPT_LEVELS[@]}"; do
            ...
            LOG_FILE="/tmp/ida_funcsim_cfg_${PROJECT_NAME}_${JSON_NAME}_${opt}.log"
