"""
Training script for Address-Aware BERT pretraining (8-Instruction Window)

Trains a BERT model with address-aware positional embeddings on:
1. Masked Language Modeling (MLM)
2. Next Sentence Prediction (NSP)

Using 8-instruction windows with 7:1 split:
...
from dataloader_paired_8inst import PairedAddressAwareDataset8Inst
...
def main():
    ...
    train_dataset = PairedAddressAwareDataset8Inst(
    ...
    if args.cfg_val and args.dfg_val:
        ...
        val_dataset = PairedAddressAwareDataset8Inst(
