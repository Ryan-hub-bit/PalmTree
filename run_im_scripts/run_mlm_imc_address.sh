...
# Run MLM + IMC + Address Training
# Instruction-level masking for CFG with address embeddings
...
echo "========================================"
echo "MLM + IMC + Address Training"
echo "========================================"
echo ""

# Experiment configuration
EXPERIMENT="mlm_imc_address"
MODEL_NAME="${EXPERIMENT}"
OUTPUT_DIR="/work/kliu14/haapr/output/${MODEL_NAME}"
LOG_DIR="/work/kliu14/haapr/log/${MODEL_NAME}"

# Task flags
TASKS="--enable_mlm --enable_imc"  # MLM + IMC (instruction masking for CFG)
...
echo "  Tasks: MLM + IMC (instruction masking for CFG)"
