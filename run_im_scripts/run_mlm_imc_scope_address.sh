...
# Run MLM + IMC + Scope + Address Training
# Instruction-level masking for CFG with scope prediction and address embeddings
...
echo "========================================"
echo "MLM + IMC + Scope + Address Training"
echo "========================================"
echo ""

# Experiment configuration
EXPERIMENT="mlm_imc_scope_address"
MODEL_NAME="${EXPERIMENT}"
OUTPUT_DIR="/work/kliu14/haapr/output/${MODEL_NAME}"
LOG_DIR="/work/kliu14/haapr/log/${MODEL_NAME}"

# Task flags
TASKS="--enable_mlm --enable_imc --enable_scope"  # MLM + IMC + Scope
...
echo "  Tasks: MLM + IMC (instruction masking) + Scope"
